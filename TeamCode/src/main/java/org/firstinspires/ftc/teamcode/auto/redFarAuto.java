...
public class redFarAuto extends NextFTCOpMode {
    ...
    private final Pose startPose = new Pose(57, 9, Math.toRadians(90)).mirror();
    private final Pose scorePose = new Pose(60, 19, Math.toRadians(111)).mirror();
    private final Pose scorePose2 = new Pose(60, 19, Math.toRadians(113)).mirror();
    private final Pose scorePose3 = new Pose(60, 19, Math.toRadians(110)).mirror();
    private final Pose goPPG = new Pose(60, 49, Math.toRadians(180)).mirror();
    private final Pose PPGc = new Pose(62, 36).mirror();
    private final Pose gPPG = new Pose(10, 49, Math.toRadians(180)).mirror();
    private final Pose goPGP = new Pose(60, 71, Math.toRadians(180)).mirror();
    private final Pose PGPc = new Pose(67, 59).mirror();
    private final Pose gPGP = new Pose(10, 71, Math.toRadians(180)).mirror();
    private final Pose goGPP = new Pose(55, 99, Math.toRadians(180)).mirror();
    private final Pose GPPc = new Pose(67, 83).mirror();
    private final Pose gGPP = new Pose(20  , 99, Math.toRadians(180)).mirror();
    private final Pose returnGPP = new Pose(53, 63).mirror();
    private final Pose leave = new Pose(38, 32, Math.toRadians(0)).mirror();
    ...
    public void buildPaths() {
        ...
        scorePreload = follower.pathBuilder()
                .addPath(new BezierLine(startPose, scorePose2))
                .setLinearHeadingInterpolation(startPose.getHeading(), scorePose2.getHeading())
                .build();

        gotoPPG = follower.pathBuilder()
                .addPath(new BezierCurve(scorePose2, PPGc, goPPG))
                .setLinearHeadingInterpolation(scorePose2.getHeading(), goPPG.getHeading())
